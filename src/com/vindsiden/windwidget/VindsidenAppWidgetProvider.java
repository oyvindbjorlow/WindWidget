...
public class VindsidenAppWidgetProvider extends AppWidgetProvider {
  ...
  private static final String tag = AppWidgetProvider.class.getName(); // getSimpleName());
	...
	/** Kalles alltid når en intent mottas - vi bør antagelig ikke endre noe mer på denne.
	 * {@inheritDoc}
	 */
	@Override
	...
	/** Kalles når hver instans lages og kalles på nytt hvis provider_config.xml fila spesifiserer frekvensintervall
	 *  Vår xml fil spesifiserer IKKE et slikt intervall, så jeg antar pt denne bare kalles 
	 *  hver gang en ny appwidget instans legges til container.
	 * {@inheritDoc}
	 */
	@Override
